...
public final class DES {
	...
	public static void main(String[] args) {
		try {
			String plaintext = "{\"qq\":\"121212\",\"second_pwd \":\"tttttt\",\"p_account\":\"ttttttt\" ,\"p_login_pwd\":\"tttttttttttt\"}";
			String akey = "12345678";


			String ciphertext = DES.encryptDES(plaintext, akey);
			System.out.println(ciphertext);
			System.out.println(DES.decryptDES(ciphertext, akey));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
