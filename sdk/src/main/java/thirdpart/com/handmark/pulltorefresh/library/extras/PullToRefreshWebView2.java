 ...
 *******************************************************************************/
package thirdpart.com.handmark.pulltorefresh.library.extras;

import android.content.Context;
import android.util.AttributeSet;
import android.webkit.WebView;

import thirdpart.com.handmark.pulltorefresh.library.PullToRefreshWebView;

import java.util.concurrent.atomic.AtomicBoolean;

/**
 * An advanced version of {@link thirdpart.com.handmark.pulltorefresh.library.PullToRefreshWebView} which delegates the
 ...
 * <p/>
 * <ul>
 * <li>{@link thirdpart.com.handmark.pulltorefresh.library.PullToRefreshWebView} doesn't work correctly because you're using
